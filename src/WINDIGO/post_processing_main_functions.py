...
def generate_relative_sensitivity_plot(
   ...
   if sens_calculation_method == 'Forward':
      ...
      raise Exception("Invalid sensitivity coefficient calculation method. Please use either 'Forward', 'Backward', or 'Central'. ")
...
def calculate_direct_perturbation_uncertainty(
   ...
   ---------
      propagated_uncertainty: float
         Value of the propagated uncertainty calculated using the Sandwich Rule from direct perturbation
         outputs.
   """ 
   ...
   if sens_calculation_method == 'Forward':
      ...
      absolute_sensitivity_coefficients = calculate_forward_coefficients(positive_perturbed_outputs = positive_perturbed_outputs,
                                                                  unperturbed_output = unperturbed_output,
                                                                  positive_perturbed_inputs = positive_perturbed_inputs,
                                                                  original_inputs = original_inputs,
                                                                  relative_flag = relative_flag)
      ...
      absolute_sensitivity_coefficients = calculate_backward_coefficients(negative_perturbed_outputs=negative_perturbed_outputs,\
                                                                   unperturbed_output=unperturbed_output,
                                                                   negative_perturbed_inputs=negative_perturbed_inputs,
                                                                   original_inputs=original_inputs,
                                                                   relative_flag=relative_flag)
      ...
      absolute_sensitivity_coefficients = calculate_central_coefficients(positive_perturbed_outputs=positive_perturbed_outputs,
                                                                  negative_perturbed_outputs=negative_perturbed_outputs,
                                                                  unperturbed_output=unperturbed_output,
                                                                  positive_perturbed_inputs=positive_perturbed_inputs,
                                                                  negative_perturbed_inputs=negative_perturbed_inputs,
...
def calculate_random_sampling_uncertainty(
   ...
   perturbed_outputs: list or ndarray
      Outputs obtained using perturbed samples from the random sampling methodology.

   Returns
   ----------
   propagated_uncertainty: float
      Value of the standard deviation of the inputted set of perturbed outputs.
