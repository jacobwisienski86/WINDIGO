...
**Documentation:** [![Documentation Status](https://readthedocs.org/projects/windigo/badge/?version=latest)](https://windigo.readthedocs.io/en/latest/)
...
Check out the documentation for WINDIGO here:

[**WINDIGO Documentation (Latest)**](https://windigo.readthedocs.io/en/latest/)
...
Artifical intelligence-based tools, primarily Microsoft Copilot, were utilized in the development of WINDIGO through prompts generated by the developers. The developers of WINDIGO claim responsibility for faults in the package's functionality that may be present within code generated through the use of articial intelligence-based tools.
